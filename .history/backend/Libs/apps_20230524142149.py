...
class FornecedoresCRUD:
    ...
    def create(self, codigo, descricao):
        ...
        consulta = self.session.query(postgre.Fornecedores).filter_by(codigo = codigo).first()
        
        if consulta:
            raise ValueError('O valor passado para cadastro já existe no banco.')
...
if __name__ == '__main__':
    ...
    crud_Fornecedor.create(1, 'BELLPAR')
