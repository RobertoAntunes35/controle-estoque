...
class EstoqueCRUD(CRUD):
    ...
    def createEstoque(self, codigo, descricao, quantidade, lote, codigo_fornecedor, unidade,data_registro, data_vencimento, tipo_entrada):
