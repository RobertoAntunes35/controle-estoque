...
from DatabasePostgreSQL import Fornecedores as dbFornecedor
from DatabasePostgreSQL import Clientes as dbCliente
from DatabasePostgreSQL import Produtos as dbProduto
from DatabasePostgreSQL import Vendedores as dbVendedor
from DatabasePostgreSQL import Estoque as dbEstoque
...
class CRUD:
    ...
    def insertValue(self, tabela,*args, **kwargs):
        for (i, arg), column in zip(enumerate(args), kwargs.values()):
            print(arg)
