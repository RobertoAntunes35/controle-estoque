...
class Clientes(ConversionExcel):
    def __init__(self, filename, **columns) -> None:
        super().__init__(filename, **columns)

class Produtos(ConversionExcel):
    def __init__(self, filename, **columns) -> None:
        super().__init__(filename, **columns)

class Fornecedores(ConversionExcel):
    def __init__(self, filename, **columns) -> None:
        super().__init__(filename, **columns)

class Vendedores(ConversionExcel):
    def __init__(self, filename, **columns) -> None:
        super().__init__(filename, **columns)

class Pedidos(ConversionExcel):
    def __init__(self, filename, **columns) -> None:
        super().__init__(filename, **columns)
