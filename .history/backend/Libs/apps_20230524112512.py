...
class Clientes(Excel):
    def __init__(self, filename, abc,**columns) -> None:
...
if __name__ == '__main__':
    ...
    clientes = Clientes('\%s' % FILES[0]['FILE_CLIENTES'][0], 'ab',**FILES[0]['FILE_CLIENTES'][1])
    ...
    atributos = [atributo for atributo in dir(clientes.__init_subclass__) if not atributo.startswith('__')]
    print(atributos)
