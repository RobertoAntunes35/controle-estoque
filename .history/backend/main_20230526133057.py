...
colunas = clientes.newDataFrame.tolist()
print(colunas)

# for codigo,razao_social,nome_fantasia,cidade,vendedor_responsavel,dia_visita in zip(
#     clientes.newArray[0],
#     clientes.newArray[1],
#     clientes.newArray[2],
#     clientes.newArray[3],
...
#     clientes.newArray[5],
#     clientes.newArray[6]):
#     print(codigo, razao_social, nome_fantasia, cidade, vendedor_responsavel, dia_visita)
